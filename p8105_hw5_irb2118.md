...
to the skewed results seen in the plot for $\mu$ values close to 0. Once
$\mu$ is sufficiently high, you reject the null so frequently that you
revocer the original normal distribution.
