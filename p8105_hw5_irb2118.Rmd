...
NEED TO DO
* Improve write up for all 3 problems
* Silence display of warnings in knit document
* work on viz on problem 2
* fix output of viz in problem 3
* Go through HW webpage, ensure we have met all requirements correctly
